...
## License
At the time of writing there is no explicit license file in this repository. If you intend to use or redistribute this project, consider adding an appropriate open‑source license or contact the repository owner for guidance.
